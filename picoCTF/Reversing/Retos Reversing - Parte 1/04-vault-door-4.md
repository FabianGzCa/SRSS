...
## Solución
```bash
fabiangzca@Astrod:~/Documents/Escuela/SRSS/picoCTF/Reversing/Retos Reversing - Parte 1$ cat VaultDoor4.java 
import java.util.*;
...
```
Modificamos un poco el codigo para que nos de la bandera:
```java
public boolean checkPassword(String password) {
        byte[] passBytes = password.getBytes();
        byte[] myBytes = {
