...
```
Notamos que para conseguir la bandera es necesario ganar 5 partidas consecutivas. Además, encontramos una función en el código que valida que el texto enviado esté entre las opciones "rock", "paper" o "scissors".

```bash
❯ nc saturn.picoctf.net 65304
