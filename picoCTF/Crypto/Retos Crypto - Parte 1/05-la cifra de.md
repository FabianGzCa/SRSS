## Objetivo
I found this cipher in an old book. Can you figure out what it says? Connect with 3.

## Solución
Ejecutamos el comando `nc jupiter.challenges.picoctf.org 58295` y nos da lo siguiente:
```text
Encrypted message:
...
entramos a la primera busqueda de vigenère cracker guballa y nos da lo siguiente:
```text
