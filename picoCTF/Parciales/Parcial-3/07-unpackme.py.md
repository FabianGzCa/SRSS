...
## Solución
Abrimos el archivo y analizamos su código:
```python
import base64
...
exec(plain.decode())
```
Modificamos un poco el programa para que al ejecutarlo en payload nos de la flag:
```python
import base64
from cryptography.fernet import Fernet
...
```
Y en el resultado nos da la flag:
